...
# Download scripts
wget https://raw.githubusercontent.com/Monmax/vast.ai-tools/master/gpu-profile/gpu-profile-daemon.sh -O $daemon_path
wget https://raw.githubusercontent.com/Monmax/vast.ai-tools/master/gpu-profile/gpu-profile.sh -O $config_maker_path
chmod +x $daemon_path
